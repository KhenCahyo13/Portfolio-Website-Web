            ...
            >
                <div className="space-y-3">
                    ...
                    <p className="text-sm text-muted-foreground md:text-base">
                        Thoughts on engineering leadership, product craft, and the pragmatic tools I
                        use daily.
                    </p>
                </div>
                ...
                {isLoading && blogs.length === 0 ? (
                    ...
                    blogs.map((blog) => {
                        const coverUrl = blog.coverImage
                            ? urlFor(blog.coverImage).width(800).height(450).url()
                            : null;
                    ...
                    <EmptyDataFallback
                        ...
                        description="Try a different keyword or reset the filters to discover more posts."
                    />
                )}
            </motion.div>
