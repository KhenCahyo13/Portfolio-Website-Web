    ...
    >
        <div className="mx-auto w-full max-w-6xl space-y-8">
            <div className="space-y-3">
                ...
                <p className="text-sm text-muted-foreground md:text-base">Fullstack engagements that highlight my range.</p>
            </div>
                        ...
                        <Card className="h-full border-white/15 bg-white/5">
                            ...
                            <CardContent className="px-4">
                                <div className="flex flex-wrap gap-2">
                                    {stack.map((tag) => (
                                        <Badge key={tag} variant="outline" className="border-white/20 bg-transparent text-xs text-muted-foreground">
                                            {tag}
                                        </Badge>
                                    ))}
                                </div>
