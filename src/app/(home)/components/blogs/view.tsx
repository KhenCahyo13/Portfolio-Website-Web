    ...
    >
        <div className="mx-auto w-full max-w-6xl space-y-8">
            <div className="space-y-3">
                ...
                <h2 className="font-heading text-3xl text-foreground">Notes on process and craft.</h2>
                <p className="text-sm text-muted-foreground md:text-base">Short reads on how I keep teams aligned and systems stable.</p>
            </div>
                    ...
                    <motion.div key={title} variants={itemVariants}>
                        <Card className="h-full border-white/15 bg-white/5">
                            <CardHeader className="px-4">
                                <CardDescription className="uppercase tracking-[0.3em] text-[0.65rem]">{date}</CardDescription>
