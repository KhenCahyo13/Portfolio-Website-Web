        ...
        <div className="mx-auto flex w-full max-w-6xl flex-col gap-10 px-0 lg:flex-row">
            <div className="flex-1 space-y-4">
                ...
                <p className="text-sm text-muted-foreground md:text-base">
                    ...
                    maintainability. My goal is to deliver solutions that scale smoothly while
                    keeping development processes simple and sustainable. With a deep understanding
                    of both frontend and backend systems, I help teams move faster without
                    sacrificing quality.
                </p>
            </div>
            <motion.div
                variants={staggerVariants}
                className="flex-1 grid items-stretch gap-4 sm:grid-cols-2"
            >
