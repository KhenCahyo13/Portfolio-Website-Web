    ...
    >
        <div className="mx-auto w-full max-w-6xl space-y-8">
            <div className="space-y-3">
                ...
                <h2 className="font-heading text-3xl text-foreground">Roles that shaped my process.</h2>
                <p className="text-sm text-muted-foreground md:text-base">
                    From individual contributor work to leading pods, I stay close to the details while keeping delivery predictable.
                </p>
            </div>
            <div className="space-y-4">
                {experienceTimeline.map(({ company, role, period, summary }) => (
                    <motion.div key={`${company}-${role}`} variants={itemVariants} initial="hidden" whileInView="show" viewport={{ once: true, amount: 0.2 }}>
