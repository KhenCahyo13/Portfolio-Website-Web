    ...
    return (
        <nav
            className={cn(
                ...
                scrolled ? "bg-[#05060a]/75 backdrop-blur supports-backdrop-filter:backdrop-blur" : "bg-transparent"
            )}
        >
            <Link href="#home" className="font-heading text-base font-semibold tracking-wide text-foreground">
                KHEN CAHYO
            </Link>
